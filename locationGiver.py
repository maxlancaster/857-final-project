...
def generator(chaser, balls, strikes, outs):
	...
	actualPitch = sequence[sequence[0]]
...
for i in range(len(datapoints)):
	if datapoints[i[1]]>0.8:
		lengthAbove10 += 1
	else:
		lengthAbove10 = 0
	if lengthAbove10 = 10:
		print "We broke it at "+str(i)
		break
...
ax.set_title("Neural Network Learning/Decoding of Follow the Leader Scheme")
# 340 at-bats needed
plt.show()